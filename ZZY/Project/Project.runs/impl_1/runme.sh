...
HD_PWD='E:/Project/Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log keyscan0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source keyscan0.tcl -notrace
